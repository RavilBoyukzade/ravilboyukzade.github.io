...
//Success message
define('__SUCCESS_MESSAGE__', "Ваше сообщение отправлено. С Вами скоро свяжутся. Спасибо Вам!");

//Error message 
define('__ERROR_MESSAGE__', "Ваше сообщение не было отправлено. Попробуйте еще раз через пару минут. Спасибо за понимание");
