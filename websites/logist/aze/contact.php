...
define("__TO__", "teklogistgrupp@mail.ru");

//Success message
define('__SUCCESS_MESSAGE__', "Sizin mektubunuz gonderilib. Sizinle tezlikle elage saxlanilacaq. Saq Olun!");

//Error message 
define('__ERROR_MESSAGE__', "Sizin mektubunuz gonderilmeyib. Zehmet olmasa bir-iki deqiqeden sonra bir daha sinayin");

//Messege when one or more fields are empty
define('__MESSAGE_EMPTY_FIELDS__', "Zehmet olmasa butun hisseleri doldurun");
